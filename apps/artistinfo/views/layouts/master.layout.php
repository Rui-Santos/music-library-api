...
<html>
	<head>
		...
		?>
		<title>Music Playground Artists - <?php echo $title; ?></title> 
	</head>
	<body>
	<div class="container">
		<div class="span-24">
			<h1>Music Playground Artists</h1>
		</div>
		...
		<div class="span-24 footer">
		  <p class="quiet bottom">
		  	 <?php echo Html::anchor('/artistinfo/', 'Music Playground Artists') ?> is &copy; <?php echo date('Y'); ?>
