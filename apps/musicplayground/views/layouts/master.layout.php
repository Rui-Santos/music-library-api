...
<html>
	<head>
		...
		?>
		<title>The Music Playground - <?php echo $title; ?></title> 
	</head>
	<body>
	<div class="container">
		<div class="span-24">
			<h1>The Music Playground</h1>
		</div>
		...
		<div class="span-24 footer">
		  <p class="quiet bottom">
		  	 <?php echo Html::anchor('/musicplayground/', 'The Music Playground') ?> is &copy; <?php echo date('Y'); ?>
