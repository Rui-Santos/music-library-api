...
<?php $form->begin(); ?>
	<fieldset>
		...
		<p>
			<label for="<?php echo $form->_FlatCategory->getName(); ?>">_ Flat Category</label><br />
			<?php $form->input('_FlatCategory'); ?>
		</p>
		<p>
			<label for="<?php echo $form->_WaveformLink->getName(); ?>">_ Waveform Link</label><br />
			<?php $form->input('_WaveformLink'); ?>
		</p>
		<p>
			<label for="<?php echo $form->_PictureLink->getName(); ?>">_ Picture Link</label><br />
			<?php $form->input('_PictureLink'); ?>
		</p>
		<p>
			<label for="<?php echo $form->_UMID->getName(); ?>">_ U M I D</label><br />
		...
		<p>
			<label for="<?php echo $form->_Dirty->getName(); ?>">_ Dirty</label><br />
