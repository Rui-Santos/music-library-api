...
class PdoDataSet implements Iterator, Countable, ArrayAccess, ISqlSelectOptions, ISqlConditions {
	 ...
	 * @return PdoDataSet
	 */	
	function selectAs($select, $as, $match, $table) { $copy = clone $this; $copy->sqlBuilder->selectAs($select, $as, $match, $table); return $copy; }
	...
	/**
	 * @see SqlBuilder::dinerMatch
	 * @return PdoDataSet
	 */	
	function dinerMatch($dinerMatchTerm, $dinerMatchConditions, $dinerMatchLibrary) { $copy = clone $this; $copy->sqlBuilder->dinerMatch($dinerMatchTerm, $dinerMatchConditions, $dinerMatchLibrary); return $copy; }

	/**
	 * @see SqlBuilder::dinerField
	 * @return PdoDataSet
	 */	
	function dinerField($dinerFields) { $copy = clone $this; $copy->sqlBuilder->dinerField($dinerFields); return $copy; }

	/**
	 * @see SqlBuilder::dinerWhereAdditions
	 * @return PdoDataSet
	 */	
	function dinerWhereAdditions($dinerWhere) { $copy = clone $this; $copy->sqlBuilder->dinerWhereAdditions($dinerWhere); return $copy; }
	...
	/**
	 * @see SqlBuilder::getTable
	 * @return string
	 */		
	function getTable() { return $this->sqlBuilder->getTable();  }
	
	/**
	 * @see SqlBuilder::getTableAlias
	 * @return string
	 */		
	function getTableAlias() { return $this->sqlBuilder->getTableAlias();  }
	
	/**
	 * @see SqlBuilder::getRawTable
	 * @return string
	 */		
	function getRawTable() { return $this->sqlBuilder->getRawTable();  }
}
?>
